...
function initEventListeners() {
    ...
    // AI 回覆按鈕
    document.getElementById('aiReplyBtn').addEventListener('click', generateAIReply);
    ...
    document.getElementById('addPromptBtnFooter').addEventListener('click', () => openPromptModal());
    ...
    // 自動回覆警告
    document.getElementById('cancelAutoReply').addEventListener('click', cancelAutoReply);
...
function renderPrompts(searchTerm = '') {
    ...
    listEl.innerHTML = filteredPrompts.map(prompt => `
