...
(function() {
    ...
    async function loadPreferences() {
        try {
            ...
            if (data.preferences) {
                elements.autoSubmitOnTimeout.checked = data.preferences.autoSubmitOnTimeout || false;
                elements.confirmBeforeSubmit.checked = data.preferences.confirmBeforeSubmit || false;
                elements.defaultLanguage.value = data.preferences.defaultLanguage || 'zh-TW';
            }
        } catch (error) {
