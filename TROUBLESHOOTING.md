...
**症状**: 在Claude Desktop的MCP Servers面板中，user-web-feedback显示为红色状态，但工具调用功能正常工作。
...
- **GitHub Issues**: [项目仓库](https://github.com/user-web-feedback/nodejs/issues)
...
# 限制日志文件大小
logrotate /etc/logrotate.d/user-web-feedback
```
