...
**全新的提示詞配置功能**，允許精細控制 AI 回覆的提示詞順序：

- ✅ **順序自定義**：獨立設定第一次/後續呼叫的提示詞順序
- ✅ **組件控制**：啟用/停用特定提示詞組件
- ✅ **內容編輯**：自定義各組件的提示詞內容
- ✅ **預設重置**：一鍵恢復預設配置
- ✅ **API 支援**：完整的 RESTful API 端點

### 🔌 擴展 API 提供商（v2.7.0）

**新增 NVIDIA 和 Z.AI (Zhipu AI) 支援**：

- ✅ **NVIDIA API**：支援 LLaMA、Nemotron 等模型
- ✅ **Z.AI (智譜 AI)**：支援 GLM 系列模型
- ✅ **地區選擇**：Z.AI 支援國際版和中國版
- ✅ **OpenAI-Compatible**：統一的 API 介面

詳細配置說明：[配置指南](.docs/CONFIGURATION.md)
